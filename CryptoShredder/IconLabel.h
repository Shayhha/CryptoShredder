...
/**
 * @brief Class for icon label for GUI that supports click events.
 */
class IconLabel : public QLabel {
    Q_OBJECT

public:
    IconLabel(const QString& imagePath, const QPoint& position, const QSize& size, QWidget* parent = nullptr) : QLabel(parent) {
